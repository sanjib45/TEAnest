          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-surface-container-lowest/50">
                {['Payee','Type','Ref ID','Amount','Status','Date','Actions'].map(h=>(
              ...
              {loading ? (
                ...
                <tr key={item._id} className="hover:bg-surface-container-lowest/40 transition-colors">
                  <td className="px-6 py-5">
                    <div className="font-bold text-primary">{item.payeeName}</div>
                  </td>
                  <td className="px-6 py-5 text-on-surface-variant">{item.paymentType}</td>
                  <td className="px-6 py-5 text-on-surface-variant">{item.referenceId || '-'}</td>
                  <td className="px-6 py-5 font-bold text-primary">₹{item.amount?.toLocaleString()}</td>
                  <td className="px-6 py-5">
                  ...
                  <td className="px-6 py-5 text-on-surface-variant">{new Date(item.paymentDate).toLocaleDateString()}</td>
                  <td className="px-6 py-5">
